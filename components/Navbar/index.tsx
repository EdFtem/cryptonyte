        ...
        <nav className="flex items-center justify-between flex-wrap bg-gray-900 p-4">
            ...
            <div className={
              ...
              (navbarOpen ? " flex-grow" : " hidden")
                ...
                <div>
                    <a href="#" className="inline-block text-base px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0">
                        Connect Wallet
                    </a>
                </div>
            </div>
